...
import { ForeignBrandMatch, FOREIGN_BRAND_MAP } from './foreignBrands';
...
function ShopContent() {
  ...
  const foreignBrandMatch = useMemo(() => {
    ...
    return detectForeignBrand(debouncedSearch);
  }, [debouncedSearch, swadeshiDismissed]);
  ...
  }, [products, selectedCategory, selectedScore, debouncedSearch, sortBy, brandQuery]);
      ...
      <main className="flex-1 overflow-hidden">
        ...
        <section className="px-10 py-8">
          <div className="mb-6 text-sm text-gray-500">
            ...
            {debouncedSearch && !isLoading ? ` for "${debouncedSearch}"` : ''}
