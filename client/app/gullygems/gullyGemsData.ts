...
export type CityKey = "Kolhapur" | "Udupi" | "Mangalore" | "Varanasi" | "Jaipur" | "Mysore" | "Haldwani" | "Manali";

export type SearchResult = CityData & { city: CityKey };

export const CITY_DB: Record<CityKey, CityData> = {
  Kolhapur: {
...
export const CITIES: CityKey[] = Object.keys(CITY_DB) as CityKey[];
